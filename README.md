...
6. AdVeil is now installed. Pin it to the toolbar for quick access.
...
2. Extract the downloaded ZIP file to a folder on your computer.
   > ⚠️ Do **NOT** delete this extracted folder after installation, browser loads the extension from here.
3. Paste the following url in browser's search bar and press enter: `edge://extensions`
4. Enable **Developer mode**.
5. Click **Load unpacked**.
6. Select the extracted folder.
7. AdVeil is now installed. Pin it to the toolbar for quick access.
...
2. Extract the downloaded ZIP file to a folder on your computer.
   > ⚠️ Do **NOT** delete this extracted folder after installation, browser loads the extension from here.
3. Paste the following url in browser's search bar and press enter: `chrome://extensions`
4. Enable **Developer mode**.
5. Click **Load unpacked**.
6. Select the extracted folder.
7. AdVeil is now installed. Pin it to the toolbar for quick access.
